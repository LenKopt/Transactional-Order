...
class OrderServiceImplTest {
    ...
    private void productForTestOrderIsAvailable(OrderDto orderDto) {
        List<String> productEntityList = orderDto.getProducts();
        productEntityList.forEach(e -> productService.addProduct(new ProductDto(e, orderDto.getQuantity())));
...
//                orderDto.getQuantity()));
    ...
    private void productForTestOrderIsAvailableWithQuantity(OrderDto orderDto, int quantity) {
        List<String> productEntityList = orderDto.getProducts();
        productEntityList.forEach(e -> productService.addProduct(new ProductDto(e, quantity)));
    }
